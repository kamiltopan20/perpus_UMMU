...
<input type="hidden" name="idp" value="<?=$idp?>">
	...
	<select name="jk"><option value="">[Pilih Jenis Kelamin]</option>
	<?php 
	$jk_p		= array("L", "P");
	...
	<select name="jenis"><option value="">[Pilih Jenis Anggota]</option>
	<?php 
	...
	<select name="status"><option value="">[Pilih Status]</option>
	<?php 
